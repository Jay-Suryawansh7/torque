  ...
  return (
    <div className={`relative px-4 py-3 min-w-[240px] rounded-xl border-2 transition-all ${
      ...
      <div className="flex items-center gap-2.5 mb-1">
        <div className="p-1.5 rounded-lg bg-red-500/10"><Database size={14} className="text-red-400" /></div>
        <span className="text-sm font-semibold text-red-100">Redis</span>
      </div>
      <div className="text-[10px] text-red-300/50 ml-9 truncate max-w-[140px]">{(config?.method as string) || "GET"}</div>
