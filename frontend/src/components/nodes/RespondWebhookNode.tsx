...
export function RespondWebhookNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 mb-1">
        ...
        <span className="text-sm font-semibold text-orange-100 truncate max-w-[200px]">
          {(config?.label as string) || "Respond to Webhook"}
        </span>
      </div>
      <div className="text-[10px] text-orange-300/50 font-mono ml-9">Returns response to webhook caller</div>
